module Scenes.Transition1.Layer1.Model exposing (layer)
...
import Scenes.Transition1.Layer1.FunctionHelp
    exposing
        ( crossButton
        , dialogueLine
        , fadeOutAlpha
            ...
            case data1.transition of
                StartTransition start ->
                    if now - start > 500 then
                        ...
                        , [ Parent (SOMMsg (SOMChangeScene Nothing "Level1"))
