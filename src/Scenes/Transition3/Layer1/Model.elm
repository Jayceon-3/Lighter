module Scenes.Transition3.Layer1.Model exposing (layer)
...
import Scenes.Transition3.Layer1.FunctionHelp exposing (dialogueLine, handleOptionSelect, update_data, userOptions)
            ...
            case data1.transition of
                StartTransition start ->
                    if now - start > 500 then
                        ...
                        , [ Parent (SOMMsg (SOMChangeScene Nothing "Level3"))
    ...
    case data.transition of
        StartTransition startTime ->
            ...
            group []
                ...
                , group [ alphamult alpha ]
                    [ P.rectCentered ( 960, 540 ) ( 1920, 1080 ) 0 Color.darkRed ]
                ]
        ...
        _ ->
            ...
            group []
                ([ base
                 , grid True
                 , P.textbox position 50 text "consolas" color
